...
namespace kernel::disk::fileSystems {
	...
	public:
		...
		~Ext2FS() override { sScreen.printError("Fin Ext2FS"); }

		explicit Ext2FS(const Ext2FS &o) : FileSystem(*this) { sScreen.printError("Copie"); }
		...
		ext2fs::inode* readInode(int num) const;
		...
		static bool isExt2FS(const char *data);
	...
	private:
		...
		ext2fs::super_block *_sb;
		ext2fs::group_desc *_groups;
